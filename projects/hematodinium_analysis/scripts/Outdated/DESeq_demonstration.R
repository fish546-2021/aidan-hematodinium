...
# This is now largely a reference file. All actions taken here are now moved into
# the function deseq_analysis() found in hematodinium_analysis_functions.R

##############################

#### Running Kallisto output through DESeq2 -----------------
...
dev.copy(png, "../graphs/day0_day17_ambient/allres_MAplot.png")
dev.off()
# Plot of full results, shrunken
plotMA(resLFC, ylim = c(-2, 2), main = "apeglm")
dev.copy(png, "../graphs/day0_day17_ambient/allres_shrunken_MAplot.png")
dev.off()
# Plot of res05 results, not shrunken
plotMA(deseq_res05, ylim = c(-20, 20))
dev.copy(png, "../graphs/day0_day17_ambient/res05_MAplot.png")
dev.off()
...
dev.copy(png, "../graphs/day0_day17_ambient/normalizedcts_v_log2foldchange.png")
dev.off()
...
dev.copy(png, "../graphs/day0_day17_ambient/PCA_plot.png")
dev.off()

# Plot dispersion estimates
plotDispEsts(deseq2.dds)
dev.copy(png, "../graphs/day0_day17_ambient/dispersion_estimates.png")
dev.off()

# write all genes to table
write.table(deseq2_tmp, "../graphs/day0_day17_ambient/0vs17_DEGlist.txt",
            row.names = TRUE, col.names = FALSE, quote = FALSE,
            sep = "\t")
write.table(deseq2_tmp, "../graphs/day0_day17_ambient/0vs17_DEGlist_wcols.txt",
            row.names = TRUE, col.names = TRUE, quote = FALSE,
            sep = "\t")

# Write significant day-differing genes to table
write.table(deseq2_tmp.sig, "../graphs/day0_day17_ambient/0vs17_DEGlist.txt",
            row.names = TRUE, col.names = FALSE, quote = FALSE,
            sep = "\t")
write.table(deseq2_tmp.sig, "../graphs/day0_day17_ambient/0vs17_DEGlist_wcols.txt",
            row.names = TRUE, col.names = TRUE, quote = FALSE,
            sep = "\t")